...
# --- CONFIGURATION ---
STUDY_NAME = "QUEST_Multi_Objective_8x8"
...
def objective(trial):
    ...
    for seed in EVAL_SEEDS:
        ...
        run_name = f"optuna_8x8/Trial_{trial.number}_Seed_{seed}_{timestamp}"
        ...
        try:
            ...
            final_perf = df['reward'].tail(1000).mean() # Evaluate over last 1000 episodes
...
if __name__ == "__main__":
    print(f"Starting Reproducible Multi-Objective Optuna Study on 8x8: {STUDY_NAME}")
