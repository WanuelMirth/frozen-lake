...
CONFIGS = {
    "QUEST_Pareto_Trial17": {
        "env_name": "FrozenLake-v1",
        "is_slippery": True,
        "map_name": "8x8",
        "total_episodes": 5000,
        "max_steps_per_episode": 200,
        "discount_rate": 0.9984889838872525,
        "exploration_constant_c": 0.025463969841312637,
        "render": False,
        "desc": "Trial 17: Candidate 1 (c=0.0255, gamma=0.9985)"
    },
    "QUEST_Pareto_Trial99": {
        "env_name": "FrozenLake-v1",
        "is_slippery": True,
        "map_name": "8x8",
        "total_episodes": 5000,
        ...
        "render": False,
        "desc": "Trial 99: Candidate 2 (c=0.0138, gamma=0.9988)"
    },
    "QUEST_Pareto_Trial79": {
        "env_name": "FrozenLake-v1",
        "is_slippery": True,
        "map_name": "8x8",
        "total_episodes": 5000,
        "max_steps_per_episode": 200,
        "discount_rate": 0.9954049752407006,
        "exploration_constant_c": 0.018231869926747853,
        "render": False,
        "desc": "Trial 79: Candidate 3 (c=0.0182, gamma=0.9954)"
    },
    "QUEST_Pareto_Trial67": {
        "env_name": "FrozenLake-v1",
        "is_slippery": True,
        "map_name": "8x8",
        "total_episodes": 5000,
        "max_steps_per_episode": 200,
        "discount_rate": 0.99442719687048,
        "exploration_constant_c": 0.04759540892759104,
        "render": False,
        "desc": "Trial 67: Candidate 4 (c=0.0476, gamma=0.9944)"
    }
}
...
def run_experiment():
    print(f"===== STARTING 8x8 SLIPPERY SWEEP (100 SEEDS, 5,000 EPISODES, 200 STEPS) =====")
